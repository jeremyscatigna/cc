...
export function Listings() {
    return (
        <div className='rounded-md flex flex-col antialiased bg-sage dark:bg-black dark:bg-grid-white/[0.05] items-center justify-center relative overflow-hidden pt-24'>
